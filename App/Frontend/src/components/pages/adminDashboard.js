...
const EditServices = () => {
    ...
    useEffect(async () => {
        await axios.get(`${process.env.REACT_APP_API_BASE_URL}/services`)
            .then(response => {
                ...
                {services.map(service => {
                    ...
                    return (
                        <tr>
                                    ...
                                    <>
                                        ...
                                        <td>
                                            <button style={{ "background-color": "red" }} onClick={() => {
                                                ...
                                                axios.put(`${process.env.REACT_APP_API_BASE_URL}/services/` + tempService.sid, tempService)
                                                    .then(response => {
                            ...
                            <button onClick={() => {
                                axios.delete(`${process.env.REACT_APP_API_BASE_URL}/services/` + service.sid)
                                    .then(response => {
